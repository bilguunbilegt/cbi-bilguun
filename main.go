...
func init() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligence password=SuperSecret host=/cloudsql/bilguun3:us-central1:mypostgres sslmode=disable port = 5432"
